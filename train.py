...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.PTPD.N_CTX_TEXT = 4  # number of context vectors at the language branch
    cfg.TRAINER.PTPD.CTX_INIT = "a photo of a"  # initialization words
    cfg.TRAINER.PTPD.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.PTPD.PROMPT_DEPTH_VISION = 9  # Max 12, minimum 0, for 0 it will be using shallow IVLP prompting (J=1)
    cfg.TRAINER.PTPD.PROMPT_DEPTH_TEXT = 9  # Max 12, minimum 0, for 0 it will be using shallow IVLP prompting (J=1)
    cfg.TRAINER.PTPD.PROJECT_LAYER = 2
    cfg.TRAINER.PTPD.CE_WEIGHT = 0.0
    cfg.TRAINER.PTPD.KD_WEIGHT= 1.0
    cfg.TRAINER.PTPD.TEMPERATURE = 1.0
    cfg.TRAINER.PTPD.TEACHER_NAME = "ViT/L-14"
